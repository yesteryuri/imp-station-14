...
public sealed class LockSystem : EntitySystem
{
    ...
    ///
    /// IMP EDIT: CHANGED THIS TO RETURN A STRING TODO: MAKE THIS BETTER SO IT DOESN'T HAVE TO RETURN A STRING
    /// in order to allow for triggering the 'FromInside' doAfter via component events
    /// </summary>
    public string CanToggleLock(Entity<LockComponent?> ent, EntityUid user, bool quiet = true)
    {
