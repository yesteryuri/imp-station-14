...
public sealed partial class CurseSummonTentacleAction : WorldTargetActionEvent
{
    /// <summary>
    /// The ID of the entity that is spawned.
    /// </summary>
    [DataField]
    public EntProtoId EntityId = "EffectCurseTentacleSpawn";
