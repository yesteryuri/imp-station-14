...
public sealed class SmokeOnTriggerSystem : EntitySystem
{
    ...
    private void OnTrigger(Entity<SmokeOnTriggerComponent> ent, ref TriggerEvent args)
    {
        ...
        _smoke.StartSmoke(smoke, ent.Comp.Solution.Clone(), (float)ent.Comp.Duration.TotalSeconds, ent.Comp.SpreadAmount, smokeComp); // imp edit, added Clone() to solution for shining spring grenades
